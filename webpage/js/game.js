...
function init() {
	...
	for (var i = 0;i <= 35;i ++) {
		...
		document.getElementById('img' + i).src = 'images/game/img0.gif';
	}
...
function showImage(imgNum) {
	...
	if (oktoclick) {
		...
		//根据传递的下标显示map中对应的图片
		imgObj.src = 'images/game/img' + map[imgNum] + '.gif';
...
function finalCheck() {
	...
	if (map[click1] == map[click2]) {
		...
		document.getElementById('img' + click1).src = 'images/game/img0.gif';
		document.getElementById('img' + click2).src = 'images/game/img0.gif';		
	}
